...
import za.ac.nwu.milesreward.domain.GeneralResponse;
...
public class AccountTypeController {
    ...
    private final FetchAccountTypeFlowInt fetchAccountTypeFlow;
    private final CreateAccountTypeFlowInt createAccountTypeFlow;

    @Autowired
    public AccountTypeController(FetchAccountTypeFlowInt fetchAccountTypeFlow,
                                 @Qualifier("createAccountTypeFlowName") CreateAccountTypeFlowInt createAccountTypeFlow) {
